@extends('masterview')
@section('tittle', 'Chi tiết bài viết')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 axil-post-wrapper">
                            <div class="post-heading">
                                <h2 class="title">How to generate blog ideas are great for businesses that sell both B2B
                                    and D2C.</h2>
                            ...
                            <p>Habitasse per feugiat aliquam luctus accumsan curae, suspendisse aliquam taciti eros neque,
                                ...
                                duis erat feugiat cras sociosqu porta ut
                                praesent, fermentum donec convallis tellus vulputate duis nibh rhoncus phasellus dui massa
                                nisl.</p>
                            ...
                            <p> MailChimp is an email marketing service provider founded in 2001. It has 9 million users
                                that collectively send over 15 billion emails through the service each month.</p>
                            ...
                            <p> Email is a crucial channel in any marketing mix, and never has this been truer than for
                                ...
                                bite-sized lesson delivers core concepts, guiding
                                    ...
                                    <div class="content">
                                        <blockquote>
                                            <p>“Email is a crucial channel in any marketing mix, and never has this been
                                                ...
                                                often to hit “send”? Each bite-sized lesson delivers core
                            ...
                            <p> December 03, 2020 - The Nike Air Zoom SuperRep 2 is designed for high-intensity interval
                                training (HIIT) in group classes or solo sessions. This second version comes with two
                                updated features for a better fit: a fully adjustable,
                                burrito-style tongue and a roomier forefoot.</p>

                            <p>The SuperRep 2 evolves an important facet of modern fitness — training as sport — and the
                                idea that it's deserving of footwear designed to support the performance needs specific to
                                these movements. That’s why the shoe keeps
                                the tech from the original SuperRep, like the forefoot Zoom Air units for pop on jumps, a
                                reinforced rand to brace against lateral bounds and a flexible “burpee break” for everyone’s
                                favorite total-body punisher.</p>

                            <p>The Nike Air Zoom SuperRep 2 releases December 10 in China, December 26 throughout EMEA and
                                January 4 globally.</p>
                                ...
                                <div class="axil-single-widget mt--40">
                                    ...
                                    <ul class="product_list_widget recent-viewed-product">
                                        ...
                                        <li>
                                            ...
                                            <div class="content">
                                                <h6 class="title"><a href="blog-details.html">Men's Fashion Tshirt</a>
                                                </h6>
